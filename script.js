...
//     // Get all product names in the featured products section
//     let productNames = document.querySelectorAll('.featured-products .product-name');

//     // Filter the product names based on the search query
//     let results = Array.from(productNames).filter((productName) => {
//         return productName.textContent.toLowerCase().includes(query.toLowerCase());
//     }).map((productName) => {
...
let paymentPop = document.querySelector('#payment-popup');


confirmOrderBtn.addEventListener('click', showPaymentOptions);
...
const toggleForget = document.querySelector('#toggle-forget');
...
toggleForget.addEventListener('click', function() {
    forgetForm.classList.add('active-ls'); // Show the forget password form
    loginForm.classList.remove('active-ls'); // Hide the login form
    signupForm.classList.remove('active-ls'); // Hide the signup form
});
document.querySelector('#back-to-login').addEventListener('click', function() {
    forgetForm.classList.remove('active-ls');
...
loginToggleBtn.onclick = () => {
    loginForm.classList.add('active-ls');
    signupForm.classList.remove('active-ls');
    forgetForm.classList.remove('active-ls'); // Hide the forget password form
};
...
const passwordUpdatedPopup = document.querySelector('#password-updated-popup');
...
resetForm.addEventListener('submit', function(event) {
  ...
  // Show the password updated popup
  passwordUpdatedPopup.style.display = 'block';
});

backToLoginLink.addEventListener('click', function(event) {
  event.preventDefault(); // Prevent default link behavior

  // Hide the password updated popup
  passwordUpdatedPopup.style.display = 'none';
});

closePopupBtn.addEventListener('click', function() {
  // Hide the password updated popup when the close button is clicked
  passwordUpdatedPopup.style.display = 'none';
});

// Hide the password updated popup initially
passwordUpdatedPopup.style.display = 'none';
